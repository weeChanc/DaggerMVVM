 ...
 */
class Preference(val ctx : Context) {
    private fun getEdit(name: String): SharedPreferences.Editor = ctx.getSharedPreferences(name, Context.MODE_PRIVATE).edit()

    private fun getPreference(name: String): SharedPreferences = ctx.getSharedPreferences(name, Context.MODE_PRIVATE)
